...
const allowedOrigins = ['http://localhost:3000', 'http://localhost:3000/login', 'https://nivakaran.dev/login', 'https://nivakaran.dev', 'https://www.nivakaran.dev/', 'https://www.nivakaran.dev/login', 'https://nivakaran.dev'];
